...
| RGBA colour | Section border | `css/base.css` | 135 | Temirlan |
...
| `padding` | Shared content sections | `css/base.css` | 134 | Temirlan |
| `border` | Shared content sections | `css/base.css` | 135 | Temirlan |
| Margin collapse explanation | Comment about section padding | `css/base.css` | 131 | Temirlan |
...
| `position: fixed` | Back-to-top link | `css/temirlan.css` | 70 | Temirlan |
